...
function myfunc(data)
        {
           ...
           req.open("GET","http://localhost/QuickRent/response.php?datavalue="+data,true);
           req.send();
		...
		<div class="wrapper">
			...
			?>
				...
				<form method="post">
					<table >
                                            <tr >
							<td style="margin: 10px !important ">Full Name:</td>
							<td style="margin: 10px !important "><input type="text" name="fname" required></td>
						</tr>
                                                <tr> <td> ------------------------ </td><td> -------------------------------- </td> </tr>
						<tr>
							<td>Phone Number:</td>
